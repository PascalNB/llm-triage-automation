\begin{table*}
    ...
    \resizebox{\linewidth}{!}{
        \begin{tabular}{lccccccccc}
            ...
            \midrule
            \textsc{GPT-4}          & \textbf{1.000} & \textit{8.456} & 0.000      & \textbf{0.950} & \textit{7.541} & 0.000      & 0.621    & \textit{10.940}      & 0.000      \\
            \textsc{Aya 23\ 8B}     & 0.844          & 1.513          & 0.000      & 0.809          & 1.421          & 0.000      & 0.516          & 1.394           & 0.000      \\
            \textsc{Code Llama 13B} & \textbf{1.000} & 3.426          & 0.000      & 0.706          & 3.389          & 0.000      & 0.529          & 3.315           & 0.000      \\
            ...
            \textsc{Llama 3\ 8B}    & \textbf{1.000} & 0.656          & 0.000      & 0.900          & 0.619          & 0.000      & \textbf{0.837}    & 0.623           & 0.000      \\
            \textsc{Mistral 7B}     & \textbf{1.000} & 0.487          & 0.000      & 0.895          & 0.411          & 0.000      & 0.743          & 0.405           & 0.000      \\
            \textsc{Phi-3 14B}      & 0.842          & 3.946          & 0.025      & 0.452          & 2.952          & 0.150      & 0.600          & 2.974           & 0.750      \\
            \textsc{Phi-3 3.8B}     & \textbf{1.000} & 0.355          & 0.000      & 0.927          & 0.375          & 0.000      & 0.706          & 0.875           & 0.000      \\
            \bottomrule
        \end{tabular}
    }
\end{table*}